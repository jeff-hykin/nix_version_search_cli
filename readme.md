...
```sh
nix-env -i -f https://github.com/jeff-hykin/nix_version_search_cli/archive/36e4aa75c53d94ff2e4b0f360166d682ba68d23b.tar.gz
# or, if you have flakes:
nix profile install 'https://github.com/jeff-hykin/nix_version_search_cli/archive/36e4aa75c53d94ff2e4b0f360166d682ba68d23b.tar.gz#nvs'
```

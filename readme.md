...
```sh
nix-env -i -f https://github.com/jeff-hykin/nix_version_search_cli/archive/bd90da2dfc0c95d53cd63cd61f539bc74d11721e.tar.gz
# or, if you have flakes:
nix profile install 'https://github.com/jeff-hykin/nix_version_search_cli/archive/bd90da2dfc0c95d53cd63cd61f539bc74d11721e.tar.gz#nvs'
```

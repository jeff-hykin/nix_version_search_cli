...
<img src="/docs/nvsc_fast.gif" alt="description">
...
```sh
nix-env -i -f https://github.com/jeff-hykin/nix_version_search_cli/archive/dab598002ffcf2f1dcaf9be63a8650258b0388c2.tar.gz
```

...
```sh
nix-env -i -f https://github.com/jeff-hykin/nix_version_search_cli/archive/6980b49cd1a8a1e79ff50e4fc0dd981e9bc37ba9.tar.gz
# or, if you have flakes:
nix profile install 'https://github.com/jeff-hykin/nix_version_search_cli/archive/6980b49cd1a8a1e79ff50e4fc0dd981e9bc37ba9.tar.gz#nvs'
```
